...
{
    public Test1(IWriter writer) : base(writer, 
        () => new ProductFaker().GenerateLazy(10), 
        () => new UserFaker().GenerateLazy(100),
        (products, users) => new OrdersFaker(products, users).GenerateLazy(100))
    {
    }
